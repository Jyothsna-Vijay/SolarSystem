...
moonGroup.rotation.z = -6.7 * Math.PI / 180; // tilt the earth to match real world
scene.add(moonGroup);
...
moonGroup.add(moonMesh); //Why not there? not infornt of caerma, no lights in scene, or mesh not added to scene
