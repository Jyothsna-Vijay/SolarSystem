...
uranusGroup.rotation.z = -97.8 * Math.PI / 180; // tilt the earth to match real world
...
uranusGroup.add(uranusMesh); //Why not there? not infornt of caerma, no lights in scene, or mesh not added to scene
...
const uranusLight = new THREE.DirectionalLight(0xffffff);// color, intensity
uranusLight.position.set(-2,0.5,1.5); //
