...
mercuryGroup.rotation.z = -0.03 * Math.PI / 180; // tilt to match real world
...
mercuryGroup.add(mercuryMesh); //Why not there? not infornt of caerma, no lights in scene, or mesh not added to scene
...
const mercuryLight = new THREE.DirectionalLight(0xffffff);// color, intensity
mercuryLight.position.set(-2,0.5,1000); //
